...
custom_bronze_ingot:
  ...
  recipes:
    1:
      cook_time: 4m
      input: custom_tin_ingot/5|custom_bronze_ingot/2
      output_quantity: 1
      type: smeltery
    2:
      type: shaped
...
custom_bronze_boots:
  ...
  recipes:
    1:
      ...
      output_quantity: 1
      input:
      - custom_bronze_ingot|custom_leather_boots|custom_bronze_ingot
...
custom_bronze_leggings:
  ...
  recipes:
    1:
      ...
      input:
      - custom_bronze_ingot|custom_bronze_ingot|custom_bronze_ingot
      - custom_bronze_ingot|custom_leather_leggings|custom_bronze_ingot
      - custom_bronze_ingot|air|custom_bronze_ingot
custom_bronze_chestplate:
  ...
  recipes:
    1:
      ...
      output_quantity: 1
      input:
      - custom_bronze_ingot|custom_leather_chestplate|custom_bronze_ingot
      - custom_bronze_ingot|custom_bronze_ingot|custom_bronze_ingot
      - custom_bronze_ingot|custom_bronze_ingot|custom_bronze_ingot
custom_bronze_helmet:
  ...
  recipes:
    1:
      ...
      input:
      - custom_bronze_ingot|custom_bronze_ingot|custom_bronze_ingot
      - custom_bronze_ingot|custom_leather_helmet|custom_bronze_ingot
      - air|air|air
    1:
      type: shaped
      output_quantity: 1
