  ...
  - if <player.has_flag[cosmetic]>:
    - if <context.args.get[1]> == test:
      ...
      - while <player.has_flag[test]>:
        - adjust <[left_wing]> armor_pose:head|0,<player.location.yaw.add[120].to_radians>,0
        - adjust <[right_wing]> armor_pose:head|0,<player.location.yaw.sub[60].to_radians>,0
        - wait 1t
