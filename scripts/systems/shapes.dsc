...
define_sphere:
  ...
  - repeat <[cir].div[0.4].round> as:value1:
    - define offset:<proc[find_offset].context[<[radius]>|<[value1].mul[<[between]>].add[90]>]>
    ...
    - repeat <[cir].div[0.4].round> as:value2:
      - define offset:<proc[find_offset].context[<[radius]>|<[value2].mul[<[between]>]>]>
