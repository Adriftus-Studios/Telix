...
health_stats_icon:
  ...
  lore:
  - "Current: <yaml[player.<player.uuid>].read[stats.<script.yaml_key[assigned_stat]>]>"
  - "Next Level: <yaml[player.<player.uuid>].read[stats.<script.yaml_key[assigned_stat]>].+[<script[default_stats].yaml_key[stats.increments.<script.yaml_key[assigned_stat]>]>]>"
  drops_on_death: false
