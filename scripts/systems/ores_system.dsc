ore_drop_events:
    ...
    events:
        on player breaks block:
            ...
            - define to_drop:<yaml[server.ore_rates].read[<context.material.name>.<context.location.biome.name>.<[drop_num]>].random||<yaml[server.ore_rates].read[<context.material.name>.all.<[drop_num]>].random>>
            - narrate <[drop_num]>
            - narrate <context.material.name>
            - narrate <context.location.biome.name>
            - narrate <yaml[server.ore_rates].read[<context.material.name>]>
            # - narrate <[to_drop]>
            - determine <[to_drop]>
