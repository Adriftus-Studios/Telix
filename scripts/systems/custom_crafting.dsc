...
custom_crafting_events:
  ...
  events:
    on player clicks in custom_crafting_inventory:
      - narrate "Test1: <script[custom_crafting_inventory].yaml_key[mapped_crafting_slots].contains[<context.raw_slot>]||false>"
      - narrate "Test2: <script[custom_crafting_inventory].yaml_key[output_slot].is[!=].to[<context.raw_slot>]>"
      - narrate "Test3: <context.raw_slot.is[LESS].than[55]>" 
