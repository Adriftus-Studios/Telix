...
update_guild_flags_gui:
  ...
  - foreach <yaml[guild.<[guild]>].list_keys[flags]> as:location:
    - define flag:<item[guild_flag].with[display_name=<yaml[guild.<[guild]>].read[flags.<[location]>.name]>;lore=<list[<&c><&chr[2764]><&sp><yaml[guild.<player.flag[guild]>].read[flags.<[location]>.health]>||<[location]>]>;nbt=<[location]>]>
