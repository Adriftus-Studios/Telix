...
guild_gui_events:
  ...
  events:
    ...
    - inventory set d:<context.inventory> slot:15 o:<item[<yaml[guild.<player.flag[guild]>].read[flag].as_item.material>].with[patterns=<yaml[guild.<player.flag[guild]>].read[flag].as_item.patterns>;base_color=<yaml[guild.<player.flag[guild]>].read[flag].as_item.base_color>]>
